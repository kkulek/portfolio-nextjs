...
export function Button({link, github, children, target}) {
    return (
        github
            ...
            : <Link href={link} target={target} className="inline-block relative px-6 py-2 bg-prm-dark text-white tracking-widest rounded shadow-xl border-2 border-amber-50
            bg-gradient-to-br from-palette-0 via-palette-1 to-palette-2 hover:to-palette-4">{children}</Link>
    )
}