...
export function Projects() {
    return (
        <section className="h-screen px-10 sm:px-20">
            <div
                className="mx-auto my-48 max-w-xl lg:max-w-[1400px] grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-12">
                        ...
                        <article key={index}
                            ...
                            <div className="relative bg-white group-hover:drop-shadow-xl">
                                <img src={basePath + item.img} alt={`Project: ${item.name}`}
                                     className="w-full rounded-xl opacity-70 transition-all duration-1000 group-hover:opacity-100"/>
                                <div className="p-6">
                                    ...
                                    <ul className="space-x-2">
                                        ...
                                        {item.stackArr.map((stack, index) =>
                                            (
                                                <li key={index}
                                                    className="inline-block font-light px-3 py-1 bg-slate-100 rounded text-sm mb-4">
                                                    {stack}
                                                </li>
                                            )
                                        )}
                                    ...
                                    <p className="font-thin mb-8">{item.short}</p>
